...
const TimelineStep = ({ step, isCompleted, order, isCurrent, isLastStep, icon, description }) => {
    ...
    <li className='relative mb-6 sm:mb-0 sm:pl-10'>
        <div className='flex items-center'>
            <div className={`z-10 flex items-center justify-center w-6 h-6 ${step?.status === 
              ...
              step?.status === 'processing' ? 'bg-blue-600 text-blue-100' : 'bg-indigo-700 text-indigo-100'}  rounded-full ring-0 ring-white shrink-0`}> 
