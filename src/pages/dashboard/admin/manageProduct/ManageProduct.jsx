...
const ManageProduct = () => { 
    ...
    const {data: {products= [],totalPages, totalProducts}={}, isLoading, isError, error, refetch} = useFetchAllProductsQuery({
        category : '',
        color : '',
        minPrice: '',
        maxPrice: '',
...
<div className="w-full  mb-12 xl:mb-0 px-4 mx-auto">
  <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
    <div className="rounded-t mb-0 px-4 py-3 border-0">
      ...
      <h3 className='my-4 text-sm'>Showing {startProduct} to {endProduct} of {totalProducts}</h3>
    </div>
