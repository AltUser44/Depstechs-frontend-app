...
const ManageUsers = () => {
    ...
    const handleCloseModel = () => { setIsModelOpen(true)
        ...
        <tbody>
            {
                users && users.map((user, index) => (
                    <tr key={index}>
                        ...
                        <span 
                        className={`rounded-full py-[2px] px-3 ${user?.role === "admin" ? "bg-indigo-500 text-white" : "bg-amber-300"}`}
                        >
                        {user?.role}
                        </span>
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-6/12 px-4 mx-auto text-center">
        <div className="text-sm text-gray-500 font-semibold py-1">
          Made with <a href="https://www.creative-tim.com/product/notus-js" className="text-gray-500 hover:text-gray-800" target="_blank">Tailwind CSS</a> by <a href="https://www.creative-tim.com" className="text-gray-500 hover:text-gray-800" target="_blank"> Kester Nkese</a>.
        </div>
      </div>
    </div>
  </div>
...
{
    isModelOpen && <UpdateUserModel user={selectedUser} onClose={handleCloseModel}
