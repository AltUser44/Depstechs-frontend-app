...
const OrderDetails = () => {
  ...
  return (
    <section className='section__container rounded p-6'>
        <h2 className='text-2xl font-semibold mb-4'>Payment {order?.order?.status}</h2>
        <p className='mb-4'> Order Id: {order?.order?.orderId}</p>
        <p className='mb-8'>Status: {order?.order?.status}</p>
