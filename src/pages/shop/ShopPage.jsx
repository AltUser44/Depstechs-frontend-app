        ...
        <>
            <section className='section__container bg-primary-light'>
                ...
                <p className='section__subheader'>
                    Browse a diverse range of categories, from plain dresses to versatile
            ...
            <section className='section__container'>
                <div className='flex flex-col md:flex-row md:gap-12 gap-8'>
                    ...
                    {/* Right side */}
                    <div>
                        <h3 className='text-xl font-medium mb-4'>Showing {startProduct} to {endProduct} of {totalPages} products</h3>
                        ...
                        <div className='mt-6 flex justify-center'>
                            ...
                            className='px-4 py-2 bg-gray-300 text-gray-700 rounded-md mr-2'>Previous</button>
                            {
                                [...Array(totalPages)].map((_, index) => (
                                    ...
                                    key={index} className={`px-4 py-2 ${currentPage === index + 1 ? 'bg-blue-500 text-white' : 'bg-gray-300 text-gray-700 rounded-md mx-1'}`}>{index + 1}</button>
                                ))
                            }
                            <button
